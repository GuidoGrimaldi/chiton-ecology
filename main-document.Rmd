...
Previous studies on boulder-chitons species have also showed non-random distribution patterns, often characterized by strong aggregation on a limited number of available boulders [@chapman1996; @chapman2002; @liversage2013]. In most case, the majority of boulders remains unoccupied while several individuals clustered on just a few [@grayson2004], However, patterns appear to vary among species and habitat [@liversage2013; @mendonca2015]. Based in a genetic study, @palmer2012 demonstrated that these aggregations are not genetically structured, as new individuals contribute to genetic diversity within the population [@palmer2012]. This is notable, as such clustering could be expected to increase intraspecific competition for space or food resource [@chelazzi1983]. It remains unclear whether these aggregations are primarily driven by the availability of food, by social behavior such attraction to conspecifics, or by specific habitat characteristics such geological rock type, boulder shape, their spatial arrangement [@takada1999; @lehir2005]. Similar aggregation behavior observed in intertidal gastropods has been interpreted as strategy to reduce disiccation stress [@levings1983] or to reduce the effects of wave action [@feare1971]. Although we did not explicitly assess wave acction disturbance regime in this study, aggregation of *I. pectinata* were only found at the Búzios reef, a site with water column height and potentially higher exposure to wave actions.
