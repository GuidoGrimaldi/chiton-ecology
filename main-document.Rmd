...
====
Fluorescence emission spectra were measured using the blue light (~450nm) with the barrier filter between the chitons and the probe and the excess of excitation light detected by the spectrometer was removed a posteriori to avoid misreading of the fluorescence emission spectra. Spectral measurements are restricted to point information on fluorescence patches. Two reflectance measurements were made for crustose red algae backgrounds present on the side of the boulders (Lithothamnium sp. and Peyssonnelia sp.). 
====
